...
import { getApiUrl } from '../config/api' // Importera vår smarta API-funktion
...
onMounted(async () => {
  try {
    // Hämta den korrekta API-URL:en (t.ex. http://SLLBI01:3003/api)
    const apiUrl = getApiUrl()
    
    // Gör anropet till /servers på rätt API-adress
