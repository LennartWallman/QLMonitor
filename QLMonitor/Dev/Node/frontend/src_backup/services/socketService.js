...
export const socketService = {
  ...
  connect() {
    ...
    // Hämta den korrekta server-URL:en från .env-filen
    const SERVER_URL = import.meta.env.VITE_API_URL || import.meta.env.VITE_API_URL || import.meta.env.VITE_API_URL || 'http://localhost:3003';
  ...
  // ✅ GENERELL EMIT-METOD (DETTA SAKNADES!)
  emit(eventName, data) {
    if (socket && socket.connected) {
